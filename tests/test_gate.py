...
EXEMPT_EXAMPLES = [
    ...
    "mugs_menu", "mugs_model:1", "mugs_order:1", "mugs_order_status",
    "admin_mug_confirm:1:123", "admin_mug_reject:1:123",
    "admin_mug_orders:0", "admin_announce_mugs_confirm", "admin_announce_mugs_go",
