...
Важное честное упрощение (не искажение): секция с "группами" (сегодня — у Фармакологии и
у Биохимии с навигацией блок → занятие → материал, см. handlers/dynamic_courses.py) возвращает
