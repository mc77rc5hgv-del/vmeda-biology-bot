...
AI_SYSTEM_PROMPT = (
    ...
    "Отвечай на русском языке обычным читаемым текстом — БЕЗ markdown и БЕЗ LaTeX-разметки: "
    "никаких \\( \\), \\[ \\], \\frac{}{}, \\cdot, \\text{}, $ и подобных конструкций с обратным "
    "слэшем. Дроби пиши через «/» (например, 0,086/0,350), умножение — знаком «×», приближённое "
    "равенство — «≈», степени и индексы — обычными символами без ^ и _ (например, SO4^2- пиши как "
    "SO4(2-) или «сульфат-ион»), единицы измерения просто текстом («г/моль», «°C»), греческие буквы "
    "словами или юникод-символом (Δ, α), не командой."
)
