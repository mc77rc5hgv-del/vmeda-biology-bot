...
def get_ai_announcement_text() -> str:
    ...
    return (
        ...
        "чёткий ответ и объяснение по шагам. Работает по биологии, физике, химии, биохимии, анатомии, "
        "оперативной хирургии и нормальной физиологии — тесты, билеты, контрольные, летучки. "
        "Для латинского языка доступен отдельный режим в разделе предмета. "
        "Просто присылаешь фото — получаешь разбор.\n\n"
...
def get_ai_menu_text(user_id: int) -> str:
    ...
    return (
        f"🤖 <b>VMedA AI</b>\n{DIVIDER}\n\n"
        "AI-помощник, который разбирает задание по фото или тексту и сразу выдаёт решение: "
        "чёткий ответ и объяснение по шагам. Работает по биологии, физике, химии, анатомии, оперативной хирургии и "
...
get_teacher_gift_announcement_text = mugs_handlers.get_teacher_gift_announcement_text
get_teacher_gift_announcement_keyboard = mugs_handlers.get_teacher_gift_announcement_keyboard
...
cb_admin_announce_teacher_mug_confirm = mugs_handlers.cb_admin_announce_teacher_mug_confirm
cb_admin_announce_teacher_mug_go = mugs_handlers.cb_admin_announce_teacher_mug_go
